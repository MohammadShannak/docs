...
/* 
Commented by Mohammad Shannak 27.08.2024 
   */
...
#include "module/goodbot/goodbot_motion.h"
...
void quickstop_stepper() {
  planner.quick_stop();
  //planner.synchronize(); //problematic with M410
  //set_current_from_steppers_for_axis(ALL_AXES);
  //sync_plan_position(); //problematic with M410
}

void resync(){
  planner.synchronize();
  motion_current_position_to_encoder();
}
 ...
 */
/**
 * \brief Main setup function where steppers, end stops, sensors, and other initializations occur.
 * This includes initialization specific to DexArm and Goodbot, such as `dexarm_init()`.
 */
void setup() {
